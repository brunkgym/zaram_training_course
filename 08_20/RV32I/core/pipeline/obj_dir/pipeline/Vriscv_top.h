...
VL_MODULE(Vriscv_top) {
  public:
    ...
    IData/*31:0*/ riscv_top__DOT__o_pc_f;
    ...
    IData/*31:0*/ riscv_top__DOT__o_rd_e;
    ...
    IData/*31:0*/ riscv_top__DOT__o_alu_result_m;
    IData/*31:0*/ riscv_top__DOT__o_write_data_m;
    ...
    IData/*31:0*/ riscv_top__DOT__u_mux_result__DOT__mux_input_arr[3];
    IData/*31:0*/ riscv_top__DOT__u_mux_pcf__DOT__mux_input_arr[2];
    ...
    WData/*95:0*/ riscv_top__DOT____Vcellinp__u_mux_result__i_mux_concat_data[3];
    ...
    QData/*63:0*/ riscv_top__DOT____Vcellinp__u_mux_pcf__i_mux_concat_data;
    ...
    static CData/*0:0*/ __Vtable2_riscv_top__DOT__o_alu_src_d[128];
    static WData/*255:0*/ __Vtable3_riscv_top__DOT__u_riscv_decode__DOT__u_riscv_ctrl__DOT__DEBUG_INSTR[2048][8];
    static QData/*63:0*/ __Vtable4_riscv_top__DOT__u_riscv_execute__DOT__u_riscv_alu__DOT__DEBUG_ALU_OP[16];
